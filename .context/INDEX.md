...
- [plans/2026-07-02-pr-update.md](plans/2026-07-02-pr-update.md) - TDD plan (2 tasks) for backlog #6: `bb pr update -p ID` (title/description) via fetch-then-merge client method, stdin-capable.
