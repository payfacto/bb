...
type themePalette struct {
	...
	greenBg  lipgloss.AdaptiveColor
...
func col(dark, light string) lipgloss.AdaptiveColor {
...
var palettes = map[string]themePalette{
	...
	// Facto — PayFacto brand palette.
	// Dark: black bg, gold accent (#bc955c), light grey text.
	// Light: white bg, darkened gold accent (#7a5c2e), near-black text.
	...
	"facto": {
		...
		surface0: col("#1e1e1e", "#f0ebe3"), // near-black select bg / soft beige
